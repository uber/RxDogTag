...
/**
 * A delegating [SingleObserver] that throws [OnErrorNotImplementedException] with stack
 ...
 * [onSubscribe()][SingleObserver.onSubscribe] or [ ][SingleObserver.onSuccess] onNext()} methods and route them through the more specific
 * [onError()][.onError] in this class for better tagging.
 *
 * @param <T> The type
</T> */
internal class DogTagSingleObserver<T>(private val config: RxDogTag.Configuration, private val delegate: SingleObserver<T>) : SingleObserver<T>, LambdaConsumerIntrospection {
