...
/**
 * A delegating [CompletableObserver] that throws [OnErrorNotImplementedException] with
 * stack element tagging to indicate the exact line number that was subscribed.
 *
 *
 * *NOTE:* This will also capture exceptions thrown by the [&quot;delegate&quot;][.delegate] 's
 * [onSubscribe()][CompletableObserver.onSubscribe] or [ ][CompletableObserver.onComplete] onComplete()} methods and route them through the more specific
 * [onError()][.onError] in this class for better tagging.
 */
internal class DogTagCompletableObserver(private val config: RxDogTag.Configuration, private val delegate: CompletableObserver) : CompletableObserver, LambdaConsumerIntrospection {
